...
<header>
	...
	<nav>
		<ul>
			...
			<li><a <?= $pag == 2 ? '' : 'href="?pagina=cidades_listar"' ?> class="<?= $pag == 2 ? 'active' : '' ?>">Cidades</a></li>
			<li><a <?= $pag == 3 ? '' : 'href="?pagina=formas_pagamento_listar"' ?> class="<?= $pag == 3 ? 'active' : '' ?>">Formas Pagamento</a></li>
			...
			<li><a <?= $pag == 7 ? '' : 'href="?pagina=clientes_listar"' ?> class="<?= $pag == 7 ? 'active' : '' ?>">Clientes</a></li>
			<li><a <?= $pag == 8 ? '' : 'href="?pagina=funcionarios_listar"' ?> class="<?= $pag == 8 ? 'active' : '' ?>">Funcionários</a></li>
			<li><a <?= $pag == 9 ? '' : 'href="?pagina=vendas_listar"' ?> class="<?= $pag == 9 ? 'active' : '' ?>">Vendas</a></li>
		</ul>
