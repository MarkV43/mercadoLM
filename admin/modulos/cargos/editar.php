<?php 
	...
	//Resgatar o id da cargo a ser editada
	$id = intval($_GET['id']);
	...
	//Script para selecionar o nome do cargo
...
<form action="" method="post" class="formulario">
	<div class="item-form">
		...
		<input type="text" value="<?php echo $nome; ?>" name="fnome" id="nome" placeholder="Digite o nome do cargo" >
	</div>
